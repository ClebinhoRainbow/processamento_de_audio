 ...
 *
 * Parâmetros: int* n_samples: número de amostras a gerar para cada canal. Se
 *               for maior que o permitido, a função gera um sinal menor que o
 *               pedido e modifica o valor desta variável.
